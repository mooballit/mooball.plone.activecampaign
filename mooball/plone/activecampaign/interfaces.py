...
class IActiveCampaignTool(zope.interface.Interface):
    ...
    def get_api_key():
        """
        Returns the API key or '' if no URL is set.

        The property name is: ``api_key``
        """
    ...
    api_key = zope.schema.TextLine(
        title=u'API Key',
        description=(u'(Prefered primary authentication method) AN API key generated by ActiveCampaign used to authenticate.')
    )
